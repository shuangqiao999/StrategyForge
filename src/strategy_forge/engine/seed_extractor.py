...
_METRIC_ANCHORS: dict[str, str] = {
    ...
    "alliance_trust": "联盟信任度（90=铁杆盟友, 50=合作关系, 20=貌合神离, 5=敌对）",
    "energy_resource": "能源资源（100=自给有余, 50=基本自足, 20=依赖进口, 5=严重短缺）",
    "grain_resource": "粮食资源（100=丰收出口, 50=自给, 20=进口依赖, 5=饥荒风险）",
    "global_reputation": "全球声誉（90=国际典范, 50=正常国家, 20=受质疑, 5=孤立/制裁）",
}
...
## 提取示例
文本："A公司以26%份额领跑市场，B公司主力产品排名第二。原材料价格反弹至20万元/吨，多家企业成本承压。地区贸易联盟对新进入者加征反补贴税。"
正确提取：A公司(cash_flow=70, market_share=85)、B公司(cash_flow=55, market_share=60)
错误提取：← 不应提取"原材料"（大宗商品）"贸易联盟"（仅作为政策背景，无战略决策描述）"多家企业"（泛指）
