...
5. 纯背景/地理语境中的实体（如仅作为地点提及的国家、城市）如果在该文本片段中没有主动行动，则不要作为独立实体提取

## 正确示例
[
  {"entity": "比亚迪", "type": "Company", "description": "中国新能源汽车制造商"},
  {"source": "比亚迪", "target": "特斯拉", "relation": "compete_price", "evidence": "比亚迪将价格压至历史低位"}
]

## 错误示例（禁止）
[
  {"entity": "中国", "type": "Country", "description": "背景国家"}  ← 在该片段中仅作为地理背景出现
  {"entity": "竞争", "type": "Concept", "description": "抽象概念"}  ← 非命名实体
]
